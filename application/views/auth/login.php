...
<head>
    ...
    <!-- page css -->
    <link href="<?php echo base_url('assets/elite_admin/dist/css/pages/login-register-lock.css'); ?>" rel="stylesheet">
    <!-- Custom CSS -->
...
<body class="horizontal-nav skin-megna card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?php echo base_url('assets/elite_admin/images/background/login-register.jpg'); ?>);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" id="loginform" action="<?php echo base_url('auth/login'); ?>">
                        ...
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
								...
								<div id="infoMessage"><?php echo '<br>'.$message;?></div>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <form class="form-horizontal" id="recoverform" action="<?php echo base_url('auth/login'); ?>">
                        <div class="form-group ">
                            <div class="col-xs-12">
